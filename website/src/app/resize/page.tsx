    ...
    <AppLayout>
      ...
      <section className="mx-auto mb-20 mt-16 max-w-5xl border-t border-white/10 pt-12 px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-normal text-white sm:text-3xl">How to use Smart Resize</h2>
        </div>
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <div className="relative rounded-[1.25rem] border border-white/10 bg-white/[0.04] p-5">
            ...
            <p className="mt-1.5 text-sm leading-6 text-white/50">Choose any image you need to resize for a specific platform.</p>
          </div>
          <div className="relative rounded-[1.25rem] border border-white/10 bg-white/[0.04] p-5">
            ...
            <h3 className="mt-3 text-sm font-semibold text-white">Select aspect ratio</h3>
            <p className="mt-1.5 text-sm leading-6 text-white/50">Pick from preset ratios (1:1, 4:5, 16:9, 9:16, 2:3) or custom.</p>
          </div>
          <div className="relative rounded-[1.25rem] border border-white/10 bg-white/[0.04] p-5">
            ...
            <h3 className="mt-3 text-sm font-semibold text-white">Adjust scale</h3>
            <p className="mt-1.5 text-sm leading-6 text-white/50">Fine-tune the size with the scale slider.</p>
          </div>
          <div className="relative rounded-[1.25rem] border border-white/10 bg-white/[0.04] p-5">
            ...
            <h3 className="mt-3 text-sm font-semibold text-white">Download all sizes</h3>
            <p className="mt-1.5 text-sm leading-6 text-white/50">Export one or all resized versions at once.</p>
          </div>
        </div>
      </section>
    </AppLayout>
